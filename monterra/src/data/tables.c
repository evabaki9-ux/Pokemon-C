...
const Move MOVES[NUM_MOVES] = {
    ...
    M("VENOM STING",  TY_BUG,     30, 100, 35, MC_PHYS, 0, ME_POISON,   30,  -1, 0, MT_FOE),
    M("VENOM JAB",    TY_BUG,     65, 100, 15, MC_PHYS, 0, ME_POISON,   20,  -1, 0, MT_FOE),
    M("DAZZLE",       TY_NORMAL,   0,  85, 20, MC_STATUS, 0, ME_CONFUSE, 100, -1, 0, MT_FOE),
    M("COLD SNAP",    TY_WATER,   45, 100, 20, MC_SPEC, 0, ME_FREEZE,   15,  -1, 0, MT_FOE),
};
...
const Species SPECIES[NUM_SPECIES] = {
    ...
    S("DEWLIN", TY_WATER, TY_NONE, 44, 48, 52, 56, 56, 48, 45, 63, 16, SP_TORRENTOL,
      ...
      L(15, MV_COLDSNAP), L(17, MV_BUBBLEBEAM), L(22, MV_HARDEN), END),
    S("SPROUTLE", TY_GRASS, TY_NONE, 45, 49, 49, 52, 56, 45, 45, 64, 16, SP_VERDANTIS,
      ...
      L(14, MV_DAZZLE), L(17, MV_SLEEPPOWDER), L(20, MV_LEAFBLADE), END),
    ...
    S("MOSSLING", TY_BUG, TY_GRASS, 50, 46, 58, 38, 52, 28, 255, 52, 0, 0,
      L(1, MV_BUGBITE), L(5, MV_STRINGSHOT), L(9, MV_ABSORB), L(12, MV_VENOMSTING),
      L(15, MV_SLEEPPOWDER), L(19, MV_VENOMJAB), END),
    S("SPARKIT", TY_ELECTRIC, TY_NONE, 38, 42, 34, 58, 42, 70, 190, 54, 0, 0,
      L(1, MV_SCRATCH), L(5, MV_SPARK), L(10, MV_HOWL), L(13, MV_DAZZLE),
      L(15, MV_THUNDERJOLT), END),
    ...
    S("TORRENTOL", TY_WATER, TY_NONE, 58, 60, 64, 74, 70, 58, 45, 143, 0, 0,
      L(1, MV_TACKLE), L(1, MV_TAILWHIP), L(6, MV_WATERGUN), L(12, MV_HEADBUTT),
      L(16, MV_COLDSNAP), L(17, MV_BUBBLEBEAM), L(24, MV_HARDEN), END),
